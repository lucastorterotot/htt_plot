...
data_datasets = []
data_datasets.append(fetch_dataset('SingleElectron_Run2017B_31Mar2018', channel=channel, prod_date=prod_date))
data_datasets.append(fetch_dataset('SingleElectron_Run2017C_31Mar2018', channel=channel, prod_date=prod_date))
data_datasets.append(fetch_dataset('SingleElectron_Run2017D_31Mar2018', channel=channel, prod_date=prod_date))
data_datasets.append(fetch_dataset('SingleElectron_Run2017E_31Mar2018', channel=channel, prod_date=prod_date))

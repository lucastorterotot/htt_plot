...
cat_dict = {'tt_inclusive':'htt_tt_7_2017'}
    #'tt_nobtag':'htt_tt_8_2017'}
            # 'tt_btag':'htt_tt_9_2017'}
...
def plot(prefit=True,bonly=True):
    ...
    for cat in cat_dict:
        ...
        plotter.draw('m_{T}^{tot}','Number of events', sys_error_hist=uncertainties, category="#tau_{h}#tau_{h} inclusive")
        if prefit:

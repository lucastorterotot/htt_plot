...
for up_down in ['up','down']:
    for syst in ['qcd_syst_{}']:#,'qcd_dm0_njet0_stat_{}','qcd_dm0_njet1_stat_{}','w_syst_{}','tt_syst_{}','w_frac_syst_{}','tt_frac_syst_{}']:
        ...
        sys_dict_weights[sys_name] = {'processes': ['all_MC','Embedded','data'],
                                      ...
                                      'DY_l1fakecut': l1_FakeFactorApplication_Region_cut & ~cfg.cut_l1_fakejet * cfg.weights['weight'] * Cut('0.5*l1_fakeweight_{}'.format(syst.format(up_down))),
                                      'DY_l2fakecut': l2_FakeFactorApplication_Region_cut & ~cfg.cut_l2_fakejet * cfg.weights['weight'] * Cut('0.5*l2_fakeweight_{}'.format(syst.format(up_down))),
                                      'TT_cut': signal_region_MC_nofakes_TT,
                                      'TT_l1fakecut': l1_FakeFactorApplication_Region_cut & ~cfg.cut_l1_fakejet * cfg.weights['weight'] * Cut('0.5*l1_fakeweight_{}'.format(syst.format(up_down))),
                                      'TT_l2fakecut': l2_FakeFactorApplication_Region_cut & ~cfg.cut_l2_fakejet * cfg.weights['weight'] * Cut('0.5*l2_fakeweight_{}'.format(syst.format(up_down))),
                                      'bkg_cut': signal_region_MC_nofakes,
                                      'bkg_l1fakecut': l1_FakeFactorApplication_Region_cut & ~cfg.cut_l1_fakejet * cfg.weights['weight'] * Cut('0.5*l1_fakeweight_{}'.format(syst.format(up_down))),
                                      'bkg_l2fakecut': l2_FakeFactorApplication_Region_cut & ~cfg.cut_l2_fakejet * cfg.weights['weight'] * Cut('0.5*l2_fakeweight_{}'.format(syst.format(up_down))),
                                      'Embedded_cut': signal_region_MC_nofakes_Embedded,
                                      'Embedded_l1fakecut': l1_FakeFactorApplication_Region_cut & ~cfg.cut_l1_fakejet * cfg.weights['weight'] * cfg.weights['embed'] * Cut('0.5*l1_fakeweight_{}'.format(syst.format(up_down))),
                                      'Embedded_l2fakecut': l2_FakeFactorApplication_Region_cut & ~cfg.cut_l2_fakejet * cfg.weights['weight'] * cfg.weights['embed'] * Cut('0.5*l2_fakeweight_{}'.format(syst.format(up_down))),
